...
export const PLACES_DATA: PlaceInfo[] = [
  ...
  },
  {
    ...
    curriculumLinks: [
      {
        subject: '미술/문화',
        title: '예원의 전통 정원 산책과 아름다운 볼거리',
        description: '아홉 번 꺾인 다리(구곡교)와 연못의 비단잉어, 기와지붕 위의 용 조각 등 예원의 전통 경관을 감상합니다.',
        guideQuestion: '예원을 천천히 걸으며 가장 예쁘거나 신기하다고 생각했던 볼거리(구곡교, 연못, 용 조각 등)와 그 이유를 편안하게 적어보세요.'
      },
      {
        subject: '도덕/가족',
  ...
  },
  {
    ...
    curriculumLinks: [
      ...
      {
        subject: '문화/감성',
        title: '마법의 성 불꽃놀이 쇼와 친구들과의 추억',
        description: '화려한 빛과 음악이 펼쳐진 야간 일루미네이션 쇼를 감상하고 친구들과 나눈 우정을 되새깁니다.',
        guideQuestion: '디즈니 마법의 성 앞에서 펼쳐진 환상적인 불꽃놀이와 음악 쇼를 보며 느꼈던 감정과, 소중한 친구들과 함께 만든 특별한 추억을 자유롭게 적어보세요.'
      }
    ],
